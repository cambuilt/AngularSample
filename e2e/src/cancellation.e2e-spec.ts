...
describe('Cancellation Test', () => {
	...
	it('should add record', () => {
		...
		element(by.id('descriptionField')).sendKeys(Key.BACK_SPACE, Key.BACK_SPACE, 'Missing Vein');
		browser.driver.sleep(500);
		...
		element(by.id('cancellationSaveButton')).click();
		browser.driver.sleep(1000);
		element(by.id('firstField')).sendKeys('PS');
		browser.driver.sleep(500);
		element(by.id('descriptionField')).sendKeys(Key.BACK_SPACE, Key.BACK_SPACE, 'Patient Sleeping');
		browser.driver.sleep(500);
		element(by.id('cancellationSaveButton')).click();
		browser.driver.sleep(1000);
